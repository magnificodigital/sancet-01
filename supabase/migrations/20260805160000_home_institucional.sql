-- Cria (ou atualiza) a home institucional como landing page editável no construtor,
-- com slug "home". A rota "/" renderiza esta página quando publicada.
INSERT INTO public.landing_pages (slug, titulo, blocos, publicado, no_menu)
VALUES (
  'home',
  'Home',
  $json$[
